 ...
 * 
 * taken from
 * https://raw.githubusercontent.com/beryx/awt-color-factory/master/src/main/java/org/beryx/awt/color/ColorFactory.java
 * 
 * repackaged!
 * 
...
public final class ColorFactory {
	 ...
	 * </div>
	 *
	 * @param colorString the name or numeric representation of the color in one of
	 *                    the supported formats
	 * @param opacity     the opacity component in range from 0.0 (transparent) to
	 *                    1.0 (opaque)
	 * @return the RGB color specified with the colorString
	 * @throws NullPointerException     if {@code colorString} is {@code null}
	 * @throws IllegalArgumentException if {@code colorString} specifies an
	 *                                  unsupported color name or contains an
	 ...
	 * <tr class="altColor">
	 * <th scope="row" class=
	 * "colFirst"><code>Color.web("rgb(255,102,136)");</code></th>
	 * <td class="colLast"><code>Color.rgb(255, 102, 136, 1.0)</code></td>
	 * </tr>
	 * <tr class="rowColor">
	 * <th scope="row" class=
	 * "colFirst"><code>Color.web("rgb(100%,50%,50%)");</code></th>
	 * <td class="colLast"><code>Color.rgb(255, 128, 128, 1.0)</code></td>
	 * </tr>
	 * <tr class="altColor">
	 * <th scope="row" class=
	 * "colFirst"><code>Color.web("rgb(255,50%,50%,0.25)");</code></th>
	 * <td class="colLast"><code>Color.rgb(255, 128, 128, 0.25)</code></td>
	 * </tr>
	 * <tr class="rowColor">
	 * <th scope="row" class=
	 * "colFirst"><code>Color.web("hsl(240,100%,100%)");</code></th>
	 * <td class="colLast"><code>Color.hsb(240.0, 1.0, 1.0, 1.0)</code></td>
	 * </tr>
	 * <tr class="altColor">
	 * <th scope="row" style="border-bottom:1px solid" class="colFirst">
	 * <code>Color.web("hsla(120,0%,0%,0.25)");</code></th>
	 * <td style="border-bottom:1px solid" class="colLast">
	 * <code>Color.hsb(120.0, 0.0, 0.0, 0.25)</code></td>
	 * </tr>
	 * </table>
	 * </div>
	 *
	...
	/**
	 * Creates a color value from a string representation. The format of the string
	 * representation is the same as in {@link #web(String)}.
	 *
	 * @param value the string to convert
	 * @throws NullPointerException     if the {@code value} is {@code null}
	 * @throws IllegalArgumentException if the {@code value} specifies an
	 *                                  unsupported color name or illegal
	 *                                  hexadecimal value
	 * @return a {@code Color} object holding the value represented by the string
	 *         argument
	 * @see #web(String)
	 */
	...
	/*
	 * Named colors moved to nested class to initialize them only when they are
	 * needed.
	 */
